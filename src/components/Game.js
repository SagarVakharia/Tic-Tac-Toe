...
const Win = (Winner) => {
    setLock(true);
    if(Winner === "x"){
        titleRef.current.innerHTML = `Congratulations:  <img src ='${cross}'> you won`
    }
    else{
        titleRef.current.innerHTML = `Congratulations:  <img src ='${circle}'> you won`
    }
}
    ...
    <div className="container">
      ...
      <div className="board">
        <div className="row1">
          ...
          {/* Here toggle(e,0) indicates the element and index number */}
